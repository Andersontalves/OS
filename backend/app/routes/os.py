...
def create_os(
    ...
    new_os = OrdemServico(
        ...
        foto_power_meter=os_data.foto_power_meter if os_data.foto_power_meter else None,
        ...
        print_os_cliente=os_data.print_os_cliente if os_data.print_os_cliente else None,
        pppoe_cliente=os_data.pppoe_cliente if os_data.pppoe_cliente else None,
